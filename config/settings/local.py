...
SECRET_KEY = env(
    "DJANGO_SECRET_KEY",
    default="xp39Zg2CjwenfjNf0qcYJnAKrIenQQq3Kg2HrTpw7DkeIkJQGDVbFf3ZIOdPKLLe",
)
# https://docs.djangoproject.com/en/dev/ref/settings/#allowed-hosts
ALLOWED_HOSTS = ["148.230.90.60","colombiadeclara.online","localhost", "0.0.0.0", "127.0.0.1"]  # noqa: S104
